...
enum class DiagnosticCode
{
    ...
    InputInformationUnclassified,
    InputWarningUnclassified,
    InputErrorUnclassified,
    InputUnexpectedInternalError,
    InputDeprecatedFunctionality,
    InputMappingCouldNotBeOpened,
    InputMappingMalformedLine,
    InputMappingUnknownKey,
    InputMappingInvalidKey,
    InputMappingPlayerOutOfRange,
    InputMappingButtonOutOfRange,
    InputMappingDirectionOutOfRange,
    InputMappingUnknownDirectionComponent,
    InputMappingUnknownPhysicalToken,
    ...
    CompiledProjectCouldNotBeOpened,
    CompiledProjectCouldNotBeCreated,
    CompiledProjectWriteFailed,
    InvalidCompiledProjectMagic,
    UnsupportedCompiledProjectFormat,
    TruncatedCompiledProject,
