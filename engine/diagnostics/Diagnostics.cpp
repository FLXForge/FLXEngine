...
namespace
{
    const std::vector<DiagnosticCodeDefinition>& definitions()
    {
        static const std::vector<DiagnosticCodeDefinition> items = {
            ...
            { DiagnosticCode::InputMappingPlayerOutOfRange, "FLX-INPUT-00014", "InputMappingPlayerOutOfRange", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping references a player outside Input Chip capacity." },
            { DiagnosticCode::InputMappingButtonOutOfRange, "FLX-INPUT-00015", "InputMappingButtonOutOfRange", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping references a button outside Input Chip capacity." },
            { DiagnosticCode::InputMappingDirectionOutOfRange, "FLX-INPUT-00016", "InputMappingDirectionOutOfRange", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping references a direction outside Input Chip capacity." },
