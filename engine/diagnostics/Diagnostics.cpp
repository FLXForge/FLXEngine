...
namespace
{
    const std::vector<DiagnosticCodeDefinition>& definitions()
    {
        static const std::vector<DiagnosticCodeDefinition> items = {
            ...
            { DiagnosticCode::InputInformationUnclassified, "FLX-INPUT-00000", "InputInformationUnclassified", DiagnosticSeverity::Info, DiagnosticDomain::INPUT, "Unclassified informational input diagnostic." },
            { DiagnosticCode::InputWarningUnclassified, "FLX-INPUT-00001", "InputWarningUnclassified", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Unclassified input warning." },
            { DiagnosticCode::InputErrorUnclassified, "FLX-INPUT-00002", "InputErrorUnclassified", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Unclassified input error." },
            { DiagnosticCode::InputUnexpectedInternalError, "FLX-INPUT-00003", "InputUnexpectedInternalError", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Unexpected internal input error." },
            { DiagnosticCode::InputDeprecatedFunctionality, "FLX-INPUT-00004", "InputDeprecatedFunctionality", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Deprecated input functionality." },
            { DiagnosticCode::InputMappingCouldNotBeOpened, "FLX-INPUT-00010", "InputMappingCouldNotBeOpened", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping file could not be opened." },
            { DiagnosticCode::InputMappingMalformedLine, "FLX-INPUT-00011", "InputMappingMalformedLine", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping line does not use key=value syntax." },
            { DiagnosticCode::InputMappingUnknownKey, "FLX-INPUT-00012", "InputMappingUnknownKey", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping contains an unknown root key." },
            { DiagnosticCode::InputMappingInvalidKey, "FLX-INPUT-00013", "InputMappingInvalidKey", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping key has invalid structure." },
            { DiagnosticCode::InputMappingPlayerOutOfRange, "FLX-INPUT-00014", "InputMappingPlayerOutOfRange", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Input mapping references a player outside the current Machine input capacity." },
            { DiagnosticCode::InputMappingButtonOutOfRange, "FLX-INPUT-00015", "InputMappingButtonOutOfRange", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Input mapping references a button outside the current Machine input capacity." },
            { DiagnosticCode::InputMappingDirectionOutOfRange, "FLX-INPUT-00016", "InputMappingDirectionOutOfRange", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Input mapping references a direction outside the current Machine input capacity." },
            { DiagnosticCode::InputMappingUnknownDirectionComponent, "FLX-INPUT-00017", "InputMappingUnknownDirectionComponent", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping references an unknown direction component." },
            { DiagnosticCode::InputMappingUnknownPhysicalToken, "FLX-INPUT-00018", "InputMappingUnknownPhysicalToken", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping references an unknown physical input token." },
            { DiagnosticCode::InputMappingEmptyBinding, "FLX-INPUT-00019", "InputMappingEmptyBinding", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping binding is empty or incomplete." },
            { DiagnosticCode::InputMappingDuplicateBinding, "FLX-INPUT-00020", "InputMappingDuplicateBinding", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping declares the same logical key more than once." },
            { DiagnosticCode::InputMappingEmpty, "FLX-INPUT-00021", "InputMappingEmpty", DiagnosticSeverity::Error, DiagnosticDomain::INPUT, "Input mapping contains no effective declarations." },
            { DiagnosticCode::InputMappingMachineControlUnmapped, "FLX-INPUT-00022", "InputMappingMachineControlUnmapped", DiagnosticSeverity::Warning, DiagnosticDomain::INPUT, "Machine exposes logical controls that the input mapping does not define." },
